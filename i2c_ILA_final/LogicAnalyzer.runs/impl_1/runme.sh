...
HD_PWD='C:/Bachelor1/i2c/i2c_ILA_final/LogicAnalyzer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_main.tcl -notrace
