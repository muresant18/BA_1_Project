...
HD_PWD='C:/Bachelor1/spi/spi_dec/spi_dec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_main.tcl
