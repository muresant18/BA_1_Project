...
HD_PWD='C:/Bachelor1/spi/spi_dec/spi_dec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_main.tcl -notrace
